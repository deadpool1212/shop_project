...
class Product():
	...
	#publisher = models.ForeignKey(Users.CustomUser, related_name='products', on_delete=models.CASCADE)
...
class Cart(models.Model):
    user = models.ForeignKey(Users.CustomUser, null=True, blank=True, on_delete='CASCADE')
